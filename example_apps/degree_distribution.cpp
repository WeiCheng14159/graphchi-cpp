...
/**
  ...
  */
struct DegreeDistributionProgram : public GraphChiProgram<VertexDataType, EdgeDataType> {
    /**
     *  Vertex update function.
     */
    void update(graphchi_vertex<VertexDataType, EdgeDataType> &vertex, graphchi_context &gcontext) {
        if (gcontext.iteration == 0) {
            vertex.set_data(vertex.num_inedges() + vertex.num_outedges());    
...
int main(int argc, const char ** argv) {
    ...
    scheduler            = false; // Whether to use selective scheduling
    ...
    /* Run */
    DegreeDistributionProgram program;
